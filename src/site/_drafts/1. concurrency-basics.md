...
**[happened-before](https://en.wikipedia.org/wiki/Happened-before)**&ensp; A relationship in concurrent programming that guarantees memory visibility and ordering of operations across threads.
